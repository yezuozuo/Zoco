...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_cms_start($tag_args) {
        ...
        $output = "<?php \n";
        if ($this->db == '') {
            $this->zoco->autoload('db');
            $this->db = $this->zoco->db;
            $output .= "global \$php;\n";
        }
        if (!is_object($this->cms)) {
            $this->cms         = $this->zoco->createModel('CMS');
            $this->cms->smarty = $this;
            $this->cms->swoole = $this->zoco;
        }
