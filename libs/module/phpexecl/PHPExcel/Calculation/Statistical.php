...
class PHPExcel_Calculation_Statistical {
     ...
     *                              This eliminates a potential endless loop error, but may have an adverse affect on
     *                              the accuracy of the function (although all my tests have so far returned correct
     *                              results).
     */
