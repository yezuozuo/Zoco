...
class PHPExcel_Calculation_LookupRef {
     ...
     *        =COLUMNS(cellAddress)
     *
     * @param    cellAddress           An array or array formula, or a reference to a range of cells for which you want
     ...
     *                                        reference).
     * @param    cols                         The number of columns, to the left or right, that you want the upper-left
     *                                        cell of the result to refer to. Using 5 as the cols argument specifies
     *                                        that the upper-left cell in the reference is five columns to the right of
     ...
     * @param    row_num                    The row in array from which to return a value. If row_num is omitted,
     *                                      column_num is required.
     * @param    column_num                 The column in array from which to return a value. If column_num is omitted,
     *                                      row_num is required.
     ...
     * @param    lookup_value        The value that you want to match in lookup_array
     * @param    lookup_array        The range of cells being searched
     * @param    index_number        The row number in table_array from which the matching value must be returned. The
     *                               first row is 1.
